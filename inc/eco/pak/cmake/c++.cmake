...
if(EXISTS ${TMP_DIR}/conandeps_legacy.cmake)
    ...
    target_include_directories(${PROJECT_NAME} PRIVATE ${gtest_PACKAGE_FOLDER_RELEASE}/include)
    target_link_directories(${PROJECT_NAME} PRIVATE ${gtest_PACKAGE_FOLDER_RELEASE}/lib)
