...
eco_get_absolute_path(SRC_DIRS)
eco_get_absolute_path(SRC_DIRS_EXCLUDE)
eco_get_absolute_path(SRC_FILES)
eco_get_absolute_path(SRC_FILES_EXCLUDE)
eco_get_absolute_path(INCLUDE_DIRS)
eco_get_absolute_path(LINK_DIRS)
message("== PRJ_DIR=${PRJ_DIR}")
message("==.BIN_DIR=${BIN_DIR}")
message("==.TMP_DIR=${TMP_DIR}")
message("== INSTALL_DIR=${INSTALL_DIR}")
message("== MAKE_DIR=${CMAKE_CURRENT_SOURCE_DIR}")
message("== MAKE_BIN_DIR=${CMAKE_CURRENT_BINARY_DIR}")
message("---------------------------------------------------------------------")
...
eco_src_files_include(SRC_FILES SRC_DIRS)
list(APPEND SRC_FILES ${SRC_FILES})
eco_src_files_exclude(SRC_FILES SRC_DIRS_EXCLUDE)
list(REMOVE_ITEM SRC_FILES ${SRC_FILES_EXCLUDE})
target_sources(${PROJECT_NAME} PRIVATE ${SRC_FILES})

# c++ target: inc & lib & install.
message("== SRC_DIRS=${SRC_DIRS}")
message("== SRC_DIRS_EXCLUDE=${SRC_DIRS_EXCLUDE}")
message("== SRC_FILES=${SRC_FILES}")
message("== SRC_FILES_EXCLUDE=${SRC_FILES_EXCLUDE}")
message("---------------------------------------------------------------------")
