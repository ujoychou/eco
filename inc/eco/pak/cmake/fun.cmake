...
# ---------------------------------------------------------------------
# exclude c++ source files in 'SRC_DIRS_EXCLUDE'
function(eco_project __PRJ_OUTPUT__ PRJ_FMT INS_DIR)
set(_PRJ_OUTPUT_ )
if(${PRJ_FMT} STREQUAL "exe")
    add_executable(${PROJECT_NAME})
    set_target_properties(${PROJECT_NAME} 
        PROPERTIES ARCHIVE_OUTPUT_DIRECTORY ${INS_DIR})
    set(_PRJ_OUTPUT_ ${INS_DIR}/${PROJECT_NAME})
elseif(${PRJ_FMT} STREQUAL "shared")
    add_library(${PROJECT_NAME} SHARED)
    set(_SUFFIX_ ".so.${PROJECT_VERSION}")
    set_target_properties(${PROJECT_NAME} 
        PROPERTIES LIBRARY_OUTPUT_DIRECTORY ${INS_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES PREFIX "lib")
    set_target_properties(${PROJECT_NAME} PROPERTIES SUFFIX ${_SUFFIX_})
    set(_PRJ_OUTPUT_ ${INS_DIR}/${PROJECT_NAME}${_SUFFIX_})
elseif(${PRJ_FMT} STREQUAL "static")
    add_library(${PROJECT_NAME} STATIC)
    set_target_properties(${PROJECT_NAME} 
        PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${INS_DIR})
    set(_PRJ_OUTPUT_ ${INS_DIR}/${PROJECT_NAME})
endif()
